...
class VideoRecorderWrapper(Wrapper):
    ...
    def __init__(
        ...
        capture_every_n_episodes: int = 10,
        log_wandb: bool = True,
        rescale_video_factor: int = 1,
    ):
        ...
        self.rescale_factor = rescale_video_factor  # downscale the rendered observations to reduce size of gifs
